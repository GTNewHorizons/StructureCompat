...
public class CompatBackpackMod {
    ...
    public CompatBackpackMod() {
        ...
        InventoryUtility.registerEnableEnderCondition(
                player -> Arrays.stream(player.inventory.mainInventory).anyMatch(
                        stack -> stack != null && stack.getItem() instanceof ItemBackpackBase
